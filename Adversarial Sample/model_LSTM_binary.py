...
# Build Model
model = Sequential()
model.add(LSTM(32, activation='relu', input_shape=(train_data_st.shape[1], 1), return_sequences=True))
...
checkpoint = ModelCheckpoint('./savemodel/binary/' + modelName + '.h5',
...
with open('./ans/History' + modelName + '_{}'.format(multiple), 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

import seaborn as sns
from sklearn.metrics import accuracy_score, confusion_matrix, precision_recall_fscore_support, roc_curve, auc

# model = tf.keras.models.load_model('/savemodel'+modelName+'.h5')
